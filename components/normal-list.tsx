          ...
          <div className="overflow-hidden rounded-lg border border-gray-100">
            <table className="w-full text-sm">
              <thead className="bg-gray-50 text-xs text-gray-500">
                <tr>
                  <th className="px-4 py-2.5 text-center font-medium">指标名称</th>
                  <th className="px-4 py-2.5 text-center font-medium">检测结果</th>
                  <th className="px-4 py-2.5 text-center font-medium">参考范围</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-50">
                {items.map((item) => (
                  <tr key={item.name} className="hover:bg-gray-50/50">
                    <td className="px-4 py-2.5 text-center text-gray-700">{item.name}</td>
                    ...
                    <td className="px-4 py-2.5 text-center text-gray-500">{item.ref || '-'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
